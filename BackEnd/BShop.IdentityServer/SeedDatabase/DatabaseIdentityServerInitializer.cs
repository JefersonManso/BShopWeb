...
public class DatabaseIdentityServerInitializer : IDatabaseSeedInitializer
{
    ...
    //        ApplicationUser admin = new ApplicationUser()
    //        {
    //            UserName = "jeferson-admin",
    //            NormalizedUserName = "JEFERSON-ADMIN",
    //            Email = "jeferson_admin@com.br",
    //            NormalizedEmail = "JEFERSON_ADMIN@COM.BR",
    //            EmailConfirmed = true,
    //            LockoutEnabled = false,
    //            PhoneNumber = "+55 (211) 12345-6789",
    //            FirstName = "Jeferson",
    //            LastName = "Admin",
    //            SecurityStamp = Guid.NewGuid().ToString()
    //        };
    ...
    //            NormalizedUserName = "JEFERSON-CLIENT",
    //            Email = "jeferson_client@com.br",
    //            NormalizedEmail = "JEFERSON_CLIENT@COM.BR",
    //            EmailConfirmed = true,
    //            LockoutEnabled = false,
    //            PhoneNumber = "+55 (21) 12345-6789",
    //            FirstName = "Jeferson",
